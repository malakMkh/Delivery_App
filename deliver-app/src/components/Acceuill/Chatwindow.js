...
function Chatwindow() {
  ...
  const toggleChat = () => {
    // Inversez l'état de la fenêtre de chat lors du clic sur le bouton
  ...
  return (
    <div className={`${style.main} ${isChatOpen ? 'open' : ''}`}>
      <div className={style.header}>
        ...
        <input
          ...
          onChange={handelname}
          maxLength={20}
          placeholder="Assitance par chat!"
        />
        <img
      ...
      <ul className={style.message_container}>
        <li className={style.message_left}>
